...
public class MapProxyArrayAdapter extends ArrayAdapter<MapInfo> {
	...
	public MapProxyArrayAdapter(Context context, ArrayList<MapInfo> list) {
		super(context, R.layout.localmaps_list_item_expanded, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		{
			rowView = inflater.inflate(R.layout.localmaps_list_item_expanded, parent, false);
			...
			ImageButton btn = (ImageButton) rowView.findViewById(R.id.imageButton_use);
	        btn.setFocusable(false);
	        btn.setOnClickListener(m_onButtonClickListener);

			btn = (ImageButton) rowView.findViewById(R.id.imageButton_edit);
	        btn.setFocusable(false);
	        btn.setOnClickListener(m_onButtonClickListener);

			btn = (ImageButton) rowView.findViewById(R.id.imageButton_delete);
	        btn.setFocusable(false);
	        btn.setOnClickListener(m_onButtonClickListener);

			btn = (ImageButton) rowView.findViewById(R.id.imageButton_upload);
	        btn.setFocusable(false);
	        btn.setOnClickListener(m_onButtonClickListener);
		...
		{
			rowView = inflater.inflate(R.layout.localmaps_list_item, parent, false);
			ImageView expandView = (ImageView) rowView.findViewById(R.id.expand_icon);
